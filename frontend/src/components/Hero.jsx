export default function Hero({ trainer }) {
  return (
    <section id="home" className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-yellow-50 pt-28 pb-20">
      <div className="container-site grid items-center gap-12 lg:grid-cols-2">
        ...
        <div className="animate-fade-in-up">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <a href="#booking-form" className="btn btn-outline">
        ...
        <div className="relative animate-fade-in lg:justify-self-end">
          ...
          <img
            src={trainer?.photo}
            alt={trainer?.name}
            className="relative aspect-[4/5] w-full max-w-md rounded-3xl object-cover shadow-2xl"
            loading="eager"
          />
          <div className="absolute -bottom-5 -left-5 rounded-2xl bg-white px-5 py-3 shadow-xl ring-1 ring-slate-100">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Goethe-Zertifikat</p>
              </div>
            </div>
          </div>
        </div>
