  ...
  const handleBook = async (e) => {
    ...
    try {
      ...
      const payResult = await payWithRazorpay({
        ...
        onFailure: (err) =>
          setStatus({ type: "error", message: "Payment failed: " + err.message + " — no money deducted.", meetLink: null }),
        onDismiss: () =>
          setStatus({ type: "error", message: "Payment cancelled. Your slot was not booked.", meetLink: null })
      });
