...
import SpokenGerman from "./components/SpokenGerman";
...
function Site() {
  ...
  useEffect(() => {
    const onHashChange = () => setCourseRouteId(courseIdFromHash());
  ...
  return (
    <>
      ...
      <main>
        ...
        />
        <SpokenGerman
          content={site.spokenGerman}
          course={site.courses?.find((c) => c.id === site.spokenGerman?.courseId)}
        />
